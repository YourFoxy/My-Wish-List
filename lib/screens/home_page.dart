...
class AddingCategoryWidget2 extends StatefulWidget {
  AddingCategoryWidget2({Key? key}) : super(key: key);

  @override
  _AddingCategoryWidget2State createState() => _AddingCategoryWidget2State();
}

class _AddingCategoryWidget2State extends State<AddingCategoryWidget2> {
